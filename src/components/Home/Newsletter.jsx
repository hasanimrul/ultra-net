...
const Newsletter = () => {
    AOS.init();
    return (
        <div className=' grid grid-cols-2 rounded bg-center bg-cover bg-fixed' style={{ backgroundImage: `url(${img})` }}>
            <div className='backdrop-brightness-50 pt-24 pb-24 pl-24'>
                <div data-aos="fade-right">
                    <div className='mb-5'>
                        <h3 className='text-3xl font-bold text-white'>Get exclusive deals by signing up to our <br /> Newsletter.</h3>
                    </div>
                    <div>
            ...
            <div className='backdrop-brightness-50 pt-24 pr-24 pb-24'>
